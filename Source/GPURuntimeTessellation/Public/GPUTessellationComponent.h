...
struct FGPUTessellationSettings {
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Tessellation",
        meta = (
            ...
            UIMin = "1", UIMax = "512",
            EditCondition = "LODMode == EGPUTessellationLODMode::Disabled", EditConditionHides))
...
public:
    ...
    /** Subtract/Mask texture (optional) - Texture mask where white = no displacement, black = full displacement.
     * Supports both UTexture2D and UTextureRenderTarget2D for realtime effects like snow melting. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "GPU Tessellation")
