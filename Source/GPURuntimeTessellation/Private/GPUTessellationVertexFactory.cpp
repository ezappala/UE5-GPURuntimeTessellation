...
IMPLEMENT_VERTEX_FACTORY_PARAMETER_TYPE(FGPUTessellationVertexFactory, SF_Vertex,
    FGPUTessellationVertexFactoryShaderParameters);

IMPLEMENT_VERTEX_FACTORY_TYPE(FGPUTessellationVertexFactory,
    "/Plugin/GPURuntimeTessellation/Private/GPUTessellationVertexFactory.ush",
    EVertexFactoryFlags::UsedWithMaterials |
    EVertexFactoryFlags::SupportsDynamicLighting |
    EVertexFactoryFlags::SupportsPositionOnly);

FGPUTessellationVertexFactory::FGPUTessellationVertexFactory(const ERHIFeatureLevel::Type InFeatureLevel)
    : FVertexFactory(InFeatureLevel) {}

void FGPUTessellationVertexFactory::SetBuffers(
    const FShaderResourceViewRHIRef& InPositionSRV, const FShaderResourceViewRHIRef& InNormalSRV,
    const FShaderResourceViewRHIRef& InUVSRV
) {
...
bool FGPUTessellationVertexFactory::ShouldCompilePermutation(
...
void FGPUTessellationVertexFactory::ModifyCompilationEnvironment(
...
void FGPUTessellationVertexFactory::ValidateCompiledResult(
    const FVertexFactoryType* Type, EShaderPlatform Platform, const FShaderParameterMap& ParameterMap,
